Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/timothyrodgers/brightcove-player-sdk-ios-oux.git", :tag => "v#{s.version}" }
  ...
  s.subspec "default" do |ss|
    ...
    ss.dependency 'Brightcove-Player-Core-testflight/default', '6.1.3'
  ...
  s.subspec "dynamic" do |ss|
    ...
    ss.dependency 'Brightcove-Player-Core-testflight/dynamic', '6.1.3'

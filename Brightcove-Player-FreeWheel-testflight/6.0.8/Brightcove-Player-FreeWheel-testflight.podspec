Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/timothyrodgers/brightcove-player-sdk-ios-fw.git", :tag => "v#{s.version}" }
  s.requires_arc = true

  s.vendored_framework   = "ios/BrightcoveFW.framework"
  s.dependency 'Brightcove-Player-Core-testflight/default', '6.0.10'
